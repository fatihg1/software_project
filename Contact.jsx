  ...
  return (
    <div className="bg-gray-100 min-h-screen py-12">
      ...
      <div className="text-center max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-blue-600">İletişim</h1>
        <p className="text-gray-600 mt-4 text-lg">
          Her türlü soru ve destek için bizimle iletişime geçebilirsiniz.
        </p>
      </div>
      ...
      <div className="mt-8 max-w-4xl mx-auto px-4 text-center">
        <div className="bg-white p-6 rounded-2xl shadow-md">
          ...
          <h2 className="text-xl font-semibold mt-4">Adres</h2>
          <p className="text-gray-600 mt-2">1234 Cadde, Şehir, Ülke</p>
        </div>
      </div>
    </div>
  );
