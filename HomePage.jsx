    ...
    return (
      <div className="relative min-h-screen">
        ...
        <div className="absolute inset-0 bg-gray-100 bg-opacity-50 flex flex-col items-center justify-center text-white text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold">Hızlı ve Kolay Tren Bileti</h1>
          <p className="text-lg md:text-xl mt-4">Seyahatinizi planlayın, en iyi fiyatları bulun!</p>
          
          <div className="mt-8 bg-white p-6 rounded-xl shadow-lg w-full max-w-2xl">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Rota Ara</h2>
