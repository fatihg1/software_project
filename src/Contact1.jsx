...
export default function ContactUs() {
  ...
  const t = translations[language].contact1;
  // Animation variants
  const fadeIn = {
    hidden: { opacity: 0 },
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-32">
        ...
        >
          {/* Phone Card */}
          <motion.div 
            className="bg-white p-6 rounded-xl shadow-md text-center h-full"
            variants={slideUp}
            initial="rest"
            whileHover="hover"
          >
            ...
            <h2 className="text-xl font-semibold mb-2">{t.phone.title}</h2>
            <p className="text-gray-600 mb-2">{t.phone.description}</p>
          ...
          >
            ...
            <p className="text-gray-600 mb-2">{t.email.description}</p>
            <a href="mailto:info@RailLink.com" className="text-blue-600 hover:text-blue-800 font-medium block">
              info@RailLink.com
            </a>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-xl font-semibold mb-2">{t.office.title}</h2>
            <p className="text-gray-600 mb-2">{t.office.description}</p>
            <address className="not-italic text-gray-700">
              {t.office.address.map((line, index) => (
                <span key={index}>
                  {line}
                  <br />
                </span>
